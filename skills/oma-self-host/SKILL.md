---
name: oma-self-host
description: Install, diagnose, check, or upgrade a self-hosted OpenMA instance using the standalone oma-self-host installer. Use for hosting OpenMA on Docker/VPS or Fly, or navigating Render/Vercel setup. This is infrastructure installation, not creating agents or sessions on an existing OpenMA API.
---
...
5. Report success only after health verification. Render/Vercel currently output
