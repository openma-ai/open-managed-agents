...
--> statement-breakpoint
INSERT INTO `__new_slack_publications`("id", "tenant_id", "user_id", "agent_id", "installation_id", "environment_id", "mode", "status", "persona_name", "persona_avatar_url", "capabilities", "session_granularity", "created_at", "unpublished_at", "client_id", "client_secret_cipher", "signing_secret_cipher", "slack_app_id") SELECT "id", "tenant_id", "user_id", "agent_id", "installation_id", "environment_id", "mode", "status", "persona_name", "persona_avatar_url", "capabilities", "session_granularity", "created_at", "unpublished_at", "client_id", "client_secret_cipher", "signing_secret_cipher", "slack_app_id" FROM `slack_publications`;--> statement-breakpoint
DROP TABLE `slack_publications`;--> statement-breakpoint
ALTER TABLE `__new_slack_publications` RENAME TO `slack_publications`;--> statement-breakpoint
