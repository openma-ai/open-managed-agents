...
| File | Purpose |
|---|---|
| `logo.svg` | Canonical OpenMA mark — header logo + SVG favicon |
| `logo.png` | Canonical mark, rasterized at 950×787. Used as JSON-LD `Organization.logo` since Google rejects SVG there. |
...
rsvg-convert -w 950 -h 787 logo.svg -o logo.png
