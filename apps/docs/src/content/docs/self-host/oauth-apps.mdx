...
See the agent-side playbook at [`skills/openma/integrations-linear.md`](https://github.com/openma-ai/open-managed-agents/blob/main/skills/openma/integrations-linear.md) for the full step-by-step.
